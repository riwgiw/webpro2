      ...
      <div className="w-full min-h-[60px] bg-[#242424] mt-[60px] fixed top-0 z-10">
        <div className="max-w-[1250px] mx-auto h-full bg-[#242424] px-4 sm:px-6 lg:px-8">
          <div className="h-[60px] flex items-center justify-center sm:justify-start  text-white font-semibold">
            <Link to='/manageuser' className="px-3 py-2 mr-[20px] rounded-lg bg-black text-[17px] sm:text-[18px] md:text-[20px]">
              Manage Users
            </Link>
      ...
      >
        <div className="mt-[30px] h-[540px] w-[420px] flex flex-col items-center">
          ...
          <div className="mt-[10px] rounded-md bg-[#242424] w-full h-[460px] p-[20px] text-[14px]">
            ...
            <input
              type="text"
              className="h-[40px] w-full rounded-md my-[10px] pl-2 focus:outline-none 
            ...
            <select
              className="h-[40px] w-full rounded-md my-[10px] px-2 focus:outline-none 
              focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#1DB954]"
              value={role}
            ...
            <button 
            type="submit"
            className="mt-[20px] h-[40px] w-full rounded-md bg-[#1DB954] font-medium text-white text-[16px]">
              Save
            </button>
          </div>
        </div>
